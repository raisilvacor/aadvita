...
(function() {
    ...
    const voiceCommands = {
        ...
        'sobre': { url: '/sobre', text: 'Abrindo página sobre a AADVITA' },
        'projetos': { url: '/projetos', text: 'Abrindo página de projetos' },
        'projeto': { url: '/projetos', text: 'Abrindo página de projetos' },
        'ações': { url: '/acoes', text: 'Abrindo página de ações' },
        'ação': { url: '/acoes', text: 'Abrindo página de ações' },
        'informativo': { url: '/informativo', text: 'Abrindo página de informativos' },
        'notícias': { url: '/informativo', text: 'Abrindo página de notícias' },
        'podcast': { url: '/informativo', text: 'Abrindo página de podcasts' },
        ...
        'videos': { url: '/videos', text: 'Abrindo página de vídeos' },
        'vídeos': { url: '/videos', text: 'Abrindo página de vídeos' },
        'video': { url: '/videos', text: 'Abrindo página de vídeos' },
        'galeria': { url: '/galeria', text: 'Abrindo galeria de fotos' },
        'galeria de fotos': { url: '/galeria', text: 'Abrindo galeria de fotos' },
        'apoiadores': { url: '/apoiadores', text: 'Abrindo página de apoiadores' },
        ...
        'transparência': { url: '/transparencia', text: 'Abrindo página de transparência' },
        'transparencia': { url: '/transparencia', text: 'Abrindo página de transparência' },
        ...
        'campanhas': { url: '/campanhas', text: 'Abrindo página de campanhas' },
        'campanha': { url: '/campanhas', text: 'Abrindo página de campanhas' },
        'apoie-nos': { url: '/apoie-nos', text: 'Abrindo página de apoio' },
        'editais': { url: '/editais', text: 'Abrindo página de editais' },
        ...
        // Comandos de Transparência
        'relatórios financeiros': { url: '/transparencia/relatorios-financeiros', text: 'Abrindo relatórios financeiros' },
        'relatorios financeiros': { url: '/transparencia/relatorios-financeiros', text: 'Abrindo relatórios financeiros' },
        'relatório financeiro': { url: '/transparencia/relatorios-financeiros', text: 'Abrindo relatórios financeiros' },
        'estatuto e documentos': { url: '/transparencia/estatuto-documentos', text: 'Abrindo estatuto e documentos' },
        'estatuto': { url: '/transparencia/estatuto-documentos', text: 'Abrindo estatuto e documentos' },
        'documentos': { url: '/transparencia/estatuto-documentos', text: 'Abrindo estatuto e documentos' },
        'prestação de contas': { url: '/transparencia/prestacao-contas', text: 'Abrindo prestação de contas' },
        'prestacao de contas': { url: '/transparencia/prestacao-contas', text: 'Abrindo prestação de contas' },
        'relatório de atividades': { url: '/transparencia/relatorios-atividades', text: 'Abrindo relatório de atividades' },
        'relatorio de atividades': { url: '/transparencia/relatorios-atividades', text: 'Abrindo relatório de atividades' },
        'relatórios de atividades': { url: '/transparencia/relatorios-atividades', text: 'Abrindo relatórios de atividades' },
        'doações e recursos': { url: '/transparencia/doacoes-recursos', text: 'Abrindo doações e recursos' },
        'doacoes e recursos': { url: '/transparencia/doacoes-recursos', text: 'Abrindo doações e recursos' },
        'doações': { url: '/transparencia/doacoes-recursos', text: 'Abrindo doações e recursos' },
        'doacoes': { url: '/transparencia/doacoes-recursos', text: 'Abrindo doações e recursos' },
        'recursos': { url: '/transparencia/doacoes-recursos', text: 'Abrindo doações e recursos' },
    ...
    function processVoiceCommand(command) {
        ...
        const keywords = {
            ...
            'rádio': { url: '/radio', text: 'Abrindo Rádio AADVITA' },
            'video': { url: '/videos', text: 'Abrindo página de vídeos' },
            'vídeo': { url: '/videos', text: 'Abrindo página de vídeos' },
            'galeria': { url: '/galeria', text: 'Abrindo galeria de fotos' },
            'informativo': { url: '/informativo', text: 'Abrindo página de informativos' },
            'sobre': { url: '/sobre', text: 'Abrindo página sobre a AADVITA' },
            'transparência': { url: '/transparencia', text: 'Abrindo página de transparência' },
            ...
            'relatório financeiro': { url: '/transparencia/relatorios-financeiros', text: 'Abrindo relatórios financeiros' },
            'estatuto': { url: '/transparencia/estatuto-documentos', text: 'Abrindo estatuto e documentos' },
            'documento': { url: '/transparencia/estatuto-documentos', text: 'Abrindo estatuto e documentos' },
            'prestação': { url: '/transparencia/prestacao-contas', text: 'Abrindo prestação de contas' },
            'prestacao': { url: '/transparencia/prestacao-contas', text: 'Abrindo prestação de contas' },
            'atividade': { url: '/transparencia/relatorios-atividades', text: 'Abrindo relatório de atividades' },
            'doação': { url: '/transparencia/doacoes-recursos', text: 'Abrindo doações e recursos' },
            'doacao': { url: '/transparencia/doacoes-recursos', text: 'Abrindo doações e recursos' },
